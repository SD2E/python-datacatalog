...
DATA = os.path.join(THIS, 'annotations', 'text')
...
def autobuild(idb, settings):
    ref_store = linkedstores.annotations.text.TextAnnotationStore(idb)
