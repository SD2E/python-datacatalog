import os
import pytest
from datacatalog import (managers, tokens)
...
def test_mgr_common_get_stores(mongodb_settings, agave):
    base = managers.common.Manager(mongodb_settings, agave=agave)
...
def test_mgr_common_measurements_from_samples(mongodb_settings):
    ...
    base = managers.common.Manager(mongodb_settings)
...
@pytest.mark.parametrize("object_id, success", [
    ('CELL_GROWTH', True), ('CELL GROWTH', False),
    ('1019c6c4-d3bd-5c5f-9cb0-09da8093aa1a', True),
