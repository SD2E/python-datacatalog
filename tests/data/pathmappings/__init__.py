CASES = [('/uploads/', '/uploads',
          '0', 'data-sd2e-community'),
         ('uploads/test/123', '/uploads',
          '0', 'data-sd2e-community'),
         ('/products/v1/test/123', '/products',
          '1', 'data-sd2e-community'),
         ('/products/', '/products',
          '1', 'data-sd2e-community'),
         ('products/v1/test/123', '/products',
          '1', 'data-sd2e-community'),
         ('/reference/genome/ecoli.fa', '/reference',
          'Reference', 'data-sd2e-community'),
