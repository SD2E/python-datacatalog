...
from ..products import ProductsFixityStore, FileFixityInstance
from ..products import FileFixtyUpdateFailure, DuplicateFilenameError, DuplicateKeyError, FileFixtyNotFoundError

# from .fixity import FileFixityInstance
STORE_NAME = 'reference'
LEVEL = 'Reference'

# TODO Refactor once we've moved the FixityStore base class
class ReferenceFixityStore(ProductsFixityStore):
    """Create and manage fixity records for references products
    Records are linked with ReferenceMetadataStore records via common hash-based
    ...
    def __init__(self, mongodb, config={}):
        super(ReferenceFixityStore, self).__init__(mongodb, config={})
