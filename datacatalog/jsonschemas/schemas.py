...
STORE_SCHEMAS = ['linkedstores.basestore', 'linkedstores.challenge_problems', 'linkedstores.experiments', 'linkedstores.samples', 'linkedstores.measurements', 'linkedstores.files', 'linkedstores.fixities']
