...
def convert_duke_validation(schema, encoding, input_file, verbose=True, output=True, output_file=None, config={}, enforce_validation=True, reactor=None):
    ...
    for duke_validation_index, duke_validation_sample in duke_validation_df.iterrows():
        ...
        if SampleConstants.EXPERIMENT_REFERENCE not in output_doc:
            output_doc[SampleConstants.CHALLENGE_PROBLEM] = "UNDEFINED"
            output_doc[SampleConstants.EXPERIMENT_REFERENCE] = "Unknown"
            output_doc[SampleConstants.EXPERIMENT_REFERENCE_URL] = "https://docs.google.com/document/d/1tcdqgBignJ_ZCdZhJNp-I1NZaK9dT1ZHc1HezXqlRma"
        ...
        lib_size = duke_validation_sample["Lib Size"]
        ...
        sample_doc[SampleConstants.REPLICATE] = 1
