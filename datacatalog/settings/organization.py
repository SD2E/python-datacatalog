...
__all__ = ['DATE_FORMAT', 'DNS_DOMAIN', 'TACC_PROJECT_NAME', 'TACC_PROJECT_ID',
           ...
           'TACC_TENANT_POC_EMAIL', 'TACC_API_SERVER',
           'TACC_PRIMARY_STORAGE_SYSTEM', 'TACC_JUPYTER_SERVER']
...
TACC_TENANT_POC_EMAIL = os.environ.get('TACC_TENANT_ADMIN', 'admin@' + DNS_DOMAIN)
