...
STORAGE_SYSTEM = os.environ.get('CATALOG_STORAGE_SYSTEM', 'data-sd2e-community')
STORAGE_MANAGED_VERSION = os.environ.get('CATALOG_STORAGE_MANAGED_VERSION', 'v2')
...
PRODUCTS_ROOT = os.environ.get('CATALOG_UPLOADS_ROOT', 'products')
